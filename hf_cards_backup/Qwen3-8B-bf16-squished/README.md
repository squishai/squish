...
This is **Qwen3-8B** (8B parameters) compressed with [Squish](https://github.com/konjoai/squish) — a local inference engine for Apple Silicon.
...
Source weights: [mlx-community/Qwen3-8B-bf16](https://huggingface.co/mlx-community/Qwen3-8B-bf16)
