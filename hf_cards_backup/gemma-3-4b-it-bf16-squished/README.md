...
This is **Gemma-3-4B-Instruct** (4B parameters) compressed with [Squish](https://github.com/konjoai/squish) — a local inference engine for Apple Silicon.
...
Source weights: [mlx-community/gemma-3-4b-it-bf16](https://huggingface.co/mlx-community/gemma-3-4b-it-bf16)
