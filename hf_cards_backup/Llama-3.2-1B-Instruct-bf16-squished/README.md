...
This is **Llama-3.2-1B-Instruct** (1B parameters) compressed with [Squish](https://github.com/konjoai/squish) — a local inference engine for Apple Silicon.
...
Smallest Llama model. Lightweight tasks, classification, and edge deployments.
...
Source weights: [mlx-community/Llama-3.2-1B-Instruct-bf16](https://huggingface.co/mlx-community/Llama-3.2-1B-Instruct-bf16)
