...
_BUNDLED: list[dict] = [
    ...
    dict(id="qwen2.5:1.5b", name="Qwen2.5-1.5B-Instruct",
         ...
         squish_repo="squishai/Qwen2.5-1.5B-Instruct-squished",
    ...
    dict(id="qwen2.5:7b", name="Qwen2.5-7B-Instruct",
         ...
         squish_repo="squishai/Qwen2.5-7B-Instruct-squished",
    ...
    dict(id="qwen2.5:14b", name="Qwen2.5-14B-Instruct",
         ...
         squish_repo="squishai/Qwen2.5-14B-Instruct-squished",
    ...
    dict(id="qwen3:0.6b", name="Qwen3-0.6B",
         ...
         squish_repo="squishai/Qwen3-0.6B-squished",
    ...
    dict(id="qwen3:1.7b", name="Qwen3-1.7B",
         ...
         squish_repo="squishai/Qwen3-1.7B-squished",
    ...
    dict(id="qwen3:4b", name="Qwen3-4B",
         ...
         squish_repo="squishai/Qwen3-4B-squished",
    ...
    dict(id="qwen3:8b", name="Qwen3-8B",
         ...
         squish_repo="squishai/Qwen3-8B-squished",
    ...
    dict(id="qwen3:14b", name="Qwen3-14B",
         ...
         squish_repo="squishai/Qwen3-14B-squished",
    ...
    dict(id="qwen3:30b-a3b", name="Qwen3-30B-A3B (MoE)",
         ...
         squish_repo="squishai/Qwen3-30B-A3B-squished",
    ...
    dict(id="llama3.1:8b", name="Llama-3.1-8B-Instruct",
         ...
         squish_repo="squishai/Meta-Llama-3.1-8B-Instruct-squished",
    ...
    dict(id="deepseek-r1:7b", name="DeepSeek-R1-Distill-Qwen-7B",
         ...
         squish_repo="squishai/DeepSeek-R1-Distill-Qwen-7B-squished",
         size_gb=14.4, squished_size_gb=3.9, params="7B", context=131072,
    ...
    dict(id="deepseek-r1:14b", name="DeepSeek-R1-Distill-Qwen-14B",
         ...
         squish_repo="squishai/DeepSeek-R1-Distill-Qwen-14B-squished",
         size_gb=28.2, squished_size_gb=7.5, params="14B", context=131072,
         tags=["reasoning"], grammar_trigger="<tool_call>"),
