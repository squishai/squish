"""
squish.speculative.adaptive_draft_budget — backwards-compatibility shim.

Module moved to ``squish.experimental.speculative.adaptive_draft_budget``.
...
_sys.modules[__name__] = _importlib.import_module(
    "squish.experimental.speculative.adaptive_draft_budget"
)
