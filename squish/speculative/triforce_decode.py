"""
squish.speculative.triforce_decode — backwards-compatibility shim.

Module moved to ``squish.experimental.speculative.triforce_decode``.
...
_sys.modules[__name__] = _importlib.import_module(
    "squish.experimental.speculative.triforce_decode"
)
