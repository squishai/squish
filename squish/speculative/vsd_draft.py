"""
squish.speculative.vsd_draft — backwards-compatibility shim.

Module moved to ``squish.experimental.speculative.vsd_draft``.
...
_sys.modules[__name__] = _importlib.import_module(
    "squish.experimental.speculative.vsd_draft"
)
