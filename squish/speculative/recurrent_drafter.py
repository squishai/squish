"""
squish.speculative.recurrent_drafter — backwards-compatibility shim.

Module moved to ``squish.experimental.speculative.recurrent_drafter``.
...
_sys.modules[__name__] = _importlib.import_module(
    "squish.experimental.speculative.recurrent_drafter"
)
