"""
squish.speculative.ngram_draft — backwards-compatibility shim.

Module moved to ``squish.experimental.speculative.ngram_draft``.
...
_sys.modules[__name__] = _importlib.import_module(
    "squish.experimental.speculative.ngram_draft"
)
