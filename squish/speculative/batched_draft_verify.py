"""
squish.speculative.batched_draft_verify — backwards-compatibility shim.

Module moved to ``squish.experimental.speculative.batched_draft_verify``.
...
_sys.modules[__name__] = _importlib.import_module(
    "squish.experimental.speculative.batched_draft_verify"
)
