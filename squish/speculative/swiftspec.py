"""
squish.speculative.swiftspec — backwards-compatibility shim.

Module moved to ``squish.experimental.speculative.swiftspec``.
...
_sys.modules[__name__] = _importlib.import_module(
    "squish.experimental.speculative.swiftspec"
)
