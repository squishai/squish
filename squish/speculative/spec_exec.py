"""
squish.speculative.spec_exec — backwards-compatibility shim.

Module moved to ``squish.experimental.speculative.spec_exec``.
...
_sys.modules[__name__] = _importlib.import_module(
    "squish.experimental.speculative.spec_exec"
)
