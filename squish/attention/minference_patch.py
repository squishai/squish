"""
squish.attention.minference_patch — backwards-compatibility shim.

Module moved to ``squish.experimental.attention.minference_patch``.
...
_sys.modules[__name__] = _importlib.import_module(
    "squish.experimental.attention.minference_patch"
)
