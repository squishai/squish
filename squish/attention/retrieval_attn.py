"""
squish.attention.retrieval_attn — backwards-compatibility shim.

Module moved to ``squish.experimental.attention.retrieval_attn``.
...
_sys.modules[__name__] = _importlib.import_module(
    "squish.experimental.attention.retrieval_attn"
)
