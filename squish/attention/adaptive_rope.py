"""
squish.attention.adaptive_rope — backwards-compatibility shim.

Module moved to ``squish.experimental.attention.adaptive_rope``.
...
_sys.modules[__name__] = _importlib.import_module(
    "squish.experimental.attention.adaptive_rope"
)
