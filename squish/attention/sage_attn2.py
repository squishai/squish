"""
squish.attention.sage_attn2 — backwards-compatibility shim.

Module moved to ``squish.experimental.attention.sage_attn2``.
...
_sys.modules[__name__] = _importlib.import_module(
    "squish.experimental.attention.sage_attn2"
)
