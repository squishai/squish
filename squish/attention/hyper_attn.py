"""
squish.attention.hyper_attn — backwards-compatibility shim.

Module moved to ``squish.experimental.attention.hyper_attn``.
...
_sys.modules[__name__] = _importlib.import_module(
    "squish.experimental.attention.hyper_attn"
)
