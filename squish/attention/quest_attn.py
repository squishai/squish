"""
squish.attention.quest_attn — backwards-compatibility shim.

Module moved to ``squish.experimental.attention.quest_attn``.
...
_sys.modules[__name__] = _importlib.import_module(
    "squish.experimental.attention.quest_attn"
)
