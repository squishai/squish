...
This is **Qwen2.5-7B-Instruct** (7B parameters), compressed with
...
[mlx-community/Qwen2.5-7B-Instruct-bf16](https://huggingface.co/mlx-community/Qwen2.5-7B-Instruct-bf16).
...
`squish run qwen2.5:7b` pulls these exact weights
(`squishai/Qwen2.5-7B-Instruct-bf16-squished`) and starts a local OpenAI/Ollama-compatible server on
...
| Property | Value |
|----------|-------|
| Base model | [mlx-community/Qwen2.5-7B-Instruct-bf16](https://huggingface.co/mlx-community/Qwen2.5-7B-Instruct-bf16) |
| Developer | Alibaba Cloud |
| Parameters | 7B |
| Quantization | INT4 (4-bit, group size 64, affine) |
| Size on disk | **4.3 GB** squished, from 15.2 GB bf16 (~72% smaller) |
