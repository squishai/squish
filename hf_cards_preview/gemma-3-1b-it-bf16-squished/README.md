...
This is **Gemma-3-1B-Instruct** (1B parameters), compressed with
...
[mlx-community/gemma-3-1b-it-bf16](https://huggingface.co/mlx-community/gemma-3-1b-it-bf16).
...
`squish run gemma3:1b` pulls these exact weights
(`squishai/gemma-3-1b-it-bf16-squished`) and starts a local OpenAI/Ollama-compatible server on
...
| Property | Value |
|----------|-------|
| Base model | [mlx-community/gemma-3-1b-it-bf16](https://huggingface.co/mlx-community/gemma-3-1b-it-bf16) |
| Developer | Google DeepMind |
| Parameters | 1B |
| Quantization | INT4 (4-bit, group size 64, affine) |
| Size on disk | **0.8 GB** squished, from 2.6 GB bf16 (~72% smaller) |
...
The original model weights are released by Google under the **Gemma Terms of Use** — review Google's terms before redistribution or commercial use. The Squish tooling that produced these weights is licensed
