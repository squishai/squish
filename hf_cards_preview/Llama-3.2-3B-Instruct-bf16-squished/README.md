...
This is **Llama-3.2-3B-Instruct** (3B parameters), compressed with
...
[mlx-community/Llama-3.2-3B-Instruct-bf16](https://huggingface.co/mlx-community/Llama-3.2-3B-Instruct-bf16).
...
`squish run llama3.2:3b` pulls these exact weights
(`squishai/Llama-3.2-3B-Instruct-bf16-squished`) and starts a local OpenAI/Ollama-compatible server on
...
| Property | Value |
|----------|-------|
| Base model | [mlx-community/Llama-3.2-3B-Instruct-bf16](https://huggingface.co/mlx-community/Llama-3.2-3B-Instruct-bf16) |
| Developer | Meta |
| Parameters | 3B |
| Quantization | INT4 (4-bit, group size 64, affine) |
| Size on disk | **1.8 GB** squished, from 6.4 GB bf16 (~72% smaller) |
