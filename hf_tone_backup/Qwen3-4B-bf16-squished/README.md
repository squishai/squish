...
This is **Qwen3-4B** (4B parameters), compressed with
...
[mlx-community/Qwen3-4B-bf16](https://huggingface.co/mlx-community/Qwen3-4B-bf16).
...
`squish run qwen3:4b` pulls these exact weights
(`squishai/Qwen3-4B-bf16-squished`) and starts a local OpenAI/Ollama-compatible server on
...
| Property | Value |
|----------|-------|
| Base model | [mlx-community/Qwen3-4B-bf16](https://huggingface.co/mlx-community/Qwen3-4B-bf16) |
| Developer | Alibaba Cloud |
| Parameters | 4B |
| Quantization | INT4 (4-bit, group size 64, affine) |
| Size on disk | **2.3 GB** squished, from 8.0 GB bf16 (~72% smaller) |
