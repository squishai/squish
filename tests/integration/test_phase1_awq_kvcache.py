...
def test_awq_save_load(tmp_path=None):
    ...
    from squish.quant.awq import load_awq_scales, save_awq_scales
...
def test_kv_int8_round_trip():
    ...
    from squish.kv.kv_cache import _dequantize_int8_per_channel, _quantize_int8_per_channel
...
def test_snapkv_eviction():
    ...
    from squish.kv.kv_cache import KVLayerCache, _snap_evict
