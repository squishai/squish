...
This is **Gemma-3-4B-Instruct** (4B parameters), compressed with
...
`squish run gemma3:4b` pulls these exact weights
(`squishai/gemma-3-4b-it-bf16-squished`) and starts a local OpenAI/Ollama-compatible server on
...
| Property | Value |
|----------|-------|
| Base model | [mlx-community/gemma-3-4b-it-bf16](https://huggingface.co/mlx-community/gemma-3-4b-it-bf16) |
| Developer | Google DeepMind |
| Parameters | 4B |
| Quantization | INT4 (4-bit, group size 64, affine) |
| Size on disk | **2.6 GB** squished, from 9.9 GB bf16 (~74% smaller) |
